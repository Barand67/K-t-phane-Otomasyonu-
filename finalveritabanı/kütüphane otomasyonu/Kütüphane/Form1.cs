...
namespace Kütüphane
{
   ...
   new SqlConnection(@"Data Source=DESKTOP-9QS8H0C\SQLEXPRESS;Initial Catalog=Kutuphane;User ID=sa;Password=123456");
        ...
        private void kitapListeleToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            baglanti.Open();
            SqlCommand komut = new SqlCommand("kitapliste", baglanti);
            komut.CommandType = CommandType.StoredProcedure;
        ...
        private void buttonUyeEkle_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlCommand komutUyeEkle = new SqlCommand("uyeekle", baglanti);
                komutUyeEkle.CommandType = CommandType.StoredProcedure;
        ...
        private void UyeListeleToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            baglanti.Open();
            SqlCommand UyeListele = new SqlCommand("uyelerliste", baglanti);
            UyeListele.CommandType = CommandType.StoredProcedure;
        ...
        private void buttonEmanetVer_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    SqlCommand komut = new SqlCommand("Emanetekle", baglanti);
                    komut.CommandType = CommandType.StoredProcedure;
        ...
        private void emanettekiKitaplarıListeleToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            baglanti.Open();
            SqlCommand komutEmanetleriListele = new SqlCommand("emanetliste", baglanti);
            komutEmanetleriListele.CommandType = CommandType.StoredProcedure;
